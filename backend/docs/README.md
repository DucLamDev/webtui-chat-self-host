...
Thư mục này chứa các quy ước kỹ thuật bắt buộc cho backend WebTui Chat.

- [API convention](api-convention.md)
- [Event convention](event-convention.md)
...
- [Cronjob và module runner](cronjobs-phase-9.md)
- [Admin, audit, health và backup](admin-audit-backup-phase-10.md)
- [Hardening, performance và observability](hardening-observability-phase-11.md)
